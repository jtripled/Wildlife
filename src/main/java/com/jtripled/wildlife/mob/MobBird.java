 ...
 * @author jtripled
 */
public class MobBird extends EntityAnimal
{
    ...
    private static final DataParameter<Byte> DATA_BIRDTYPE = EntityDataManager.createKey(MobBird.class, DataSerializers.BYTE);
    private static final DataParameter<Byte> DATA_BIRDFLAGS = EntityDataManager.createKey(MobBird.class, DataSerializers.BYTE);
    private BlockPos spawnPosition;
    private int currentFlightTime;

    public MobBird(World par1World)
    {
        super(par1World);
    ...
    public static class EntityAITFBirdFly extends EntityAIBase
    {
	private MobBird entity;

	public EntityAITFBirdFly(MobBird par1EntityCreature)
        {
